  ...
  <div class="products-container">
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="page-subtitle">Gestiona todos los productos del sistema</p>
      </div>
      <Button
    ...
    <DataTable
      ...
      :emptyMessage="productsStore.error || 'No hay productos registrados'"
    ...
    >
      ...
      <Column header="Cantidad" style="min-width: 150px">
        <template #body="slotProps">
          <div class="date-cell">
      ...
      <Column header="Precio" style="min-width: 150px">
        <template #body="slotProps">
          <div class="date-cell">
            <i class="pi pi-dollar date-icon"></i>
      ...
      <Column header="IVA" style="min-width: 150px">
        <template #body="slotProps">
          <div class="date-cell">
            <i class="pi pi-percent date-icon"></i>
            <span>{{ slotProps.data.iva }}</span>
          </div>
        </template>
      </Column>
    ...
    >
      <DialogProduct
        :productData="selectedProduct ? selectedProduct : null"
...
import DialogProduct from '@/views/products/components/DialogProducts.vue'
// PrimeVue Components
