import {
  ...
  script2 as script12,
  script3 as script13
} from "./chunk-TRVRKNNA.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus,
  _default,
  getVNodeProp
} from "./chunk-4VNOQVO7.js";
import {
  script as script11
} from "./chunk-DF7HOSFF.js";
import {
  script as script14
} from "./chunk-3LVLQTSH.js";
import {
  script as script8
} from "./chunk-VIEIEHJB.js";
import {
  script as script10
} from "./chunk-HU6GLSQP.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-N3W6KMUD.js";
import {
  FocusTrap
} from "./chunk-RK3ULAFN.js";
import {
  script as script5,
  script2 as script6
} from "./chunk-WXMP2YD3.js";
import {
  script as script4
} from "./chunk-GSDK4L6Z.js";
import {
  script as script7
} from "./chunk-4V6TZJB7.js";
import {
  script as script3
} from "./chunk-JRDDEZ6Y.js";
import {
  Ripple
} from "./chunk-A3QNQLIM.js";
import {
  script as script2
} from "./chunk-ZOZGX3GV.js";
import "./chunk-FMM4ZAHG.js";
import {
  script
} from "./chunk-GX3FAXAS.js";
import {
  BaseStyle,
  C,
  C2,
...
function _slicedToArray2(r, e) {
  return _arrayWithHoles2(r) || _iterableToArrayLimit2(r, e) || _unsupportedIterableToArray22(r, e) || _nonIterableRest2();
}
...
var script37 = {
  ...
  data: function data13() {
    return {
      ...
      d_multiSortMeta: this.multiSortMeta ? _toConsumableArray21(this.multiSortMeta) : [],
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data14 = _toConsumableArray21(value);
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      if (this.groupRowsBy && (this.d_groupRowsSortMeta || this.d_multiSortMeta.length && this.groupRowsBy === this.d_multiSortMeta[0].field)) {
        ...
        if (firstSortMeta.field !== this.d_groupRowsSortMeta.field) {
          this.d_multiSortMeta = [this.d_groupRowsSortMeta].concat(_toConsumableArray21(this.d_multiSortMeta));
        }
      }
      var data14 = _toConsumableArray21(value);
      data14.sort(function(data1, data22) {
    ...
    addMultiSortField: function addMultiSortField(field2) {
      ...
      this.d_multiSortMeta = _toConsumableArray21(this.d_multiSortMeta);
    },
          ...
          if (metaSelection) {
            ...
            if (selected && metaKey) {
              ...
              if (this.isSingleSelectionMode()) {
                ...
                _selection2 = [].concat(_toConsumableArray21(_selection2), [rowData]);
            ...
            if (this.selectionMode === "single") {
              ...
              if (selected) {
                ...
                var _selection4 = this.selection ? [].concat(_toConsumableArray21(this.selection), [rowData]) : [rowData];
    ...
    onSpaceKey: function onSpaceKey(event, rowData, rowIndex2, slotProps) {
      ...
      if (event.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = C(this.selection[0], data14);
          lastSelectedRowIndex = C(this.selection[this.selection.length - 1], data14);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = C(this.selection, data14);
        }
    ...
    toggleRowWithCheckbox: function toggleRowWithCheckbox2(event) {
      ...
      if (this.isSelected(rowData)) {
        ...
        var _selection5 = this.selection ? _toConsumableArray21(this.selection) : [];
        _selection5 = [].concat(_toConsumableArray21(_selection5), [rowData]);
    ...
    toggleRowsWithCheckbox: function toggleRowsWithCheckbox(event) {
      if (this.selectAll !== null) {
        ...
        var _selection = [];
        if (checked2) {
          _selection = this.frozenValue ? [].concat(_toConsumableArray21(this.frozenValue), _toConsumableArray21(this.processedData)) : this.processedData;
    ...
    generateCSV: function generateCSV(options, data14) {
      ...
      if (!data14) {
        ...
        else if (this.frozenValue) data14 = data14 ? [].concat(_toConsumableArray21(this.frozenValue), _toConsumableArray21(data14)) : this.frozenValue;
      }
    ...
    onColumnHeaderDrop: function onColumnHeaderDrop(e) {
      ...
      if (this.draggedColumnElement) {
        ...
        if (allowDrop) {
          ...
          var reorderedWidths = [].concat(_toConsumableArray21(remainingItems.slice(0, dropColIndex)), [movedItem], _toConsumableArray21(remainingItems.slice(dropColIndex)));
    ...
    onRowDrop: function onRowDrop2(event) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray21(this.processedData);
    ...
    toggleRow: function toggleRow2(event) {
      ...
      if (this.dataKey) {
        ...
        expandedRows = this.expandedRows ? _toConsumableArray21(this.expandedRows) : [];
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      ...
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray21(this.expandedRowGroups) : [];
    ...
    onRowEditInit: function onRowEditInit3(event) {
      var _editingRows = this.editingRows ? _toConsumableArray21(this.editingRows) : [];
      _editingRows.push(event.data);
      this.$emit("update:editingRows", _editingRows);
      this.$emit("row-edit-init", event);
    },
    onRowEditSave: function onRowEditSave3(event) {
      var _editingRows = _toConsumableArray21(this.editingRows);
  ...
  computed: {
    columns: function columns() {
      ...
      if (cols && this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray21(cols.filter(function(item) {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        var val = this.frozenValue ? [].concat(_toConsumableArray21(this.frozenValue), _toConsumableArray21(this.processedData)) : this.processedData;
